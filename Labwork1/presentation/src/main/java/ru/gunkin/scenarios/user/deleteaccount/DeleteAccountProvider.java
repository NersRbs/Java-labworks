...
public class DeleteAccountProvider implements ScenarioProvider {
    private final CurrentService currentService;
    private final UserService userService;

    public DeleteAccountProvider(CurrentService currentService, UserService userService) {
    ...
    public Scenario tryGetScenario() {
        if (currentService.getState() instanceof UserState) {
            return new DeleteAccountScenario(userService);
        }
        return null;
    }
}
