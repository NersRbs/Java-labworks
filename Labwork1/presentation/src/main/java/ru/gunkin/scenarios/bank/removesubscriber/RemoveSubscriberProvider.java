...
public class RemoveSubscriberProvider implements ScenarioProvider {
    private final CurrentService currentService;
    private final BankService bankService;

    public RemoveSubscriberProvider(CurrentService currentService, BankService bankService) {
    ...
    public Scenario tryGetScenario() {
        if (currentService.getState() instanceof AdminState)
            return new RemoveSubscriberScenario(bankService);
        return null;
    }
}
